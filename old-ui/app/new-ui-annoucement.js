    ...
    return (
      h('div.new-ui-announcement', [
        ...
        h('section.new-ui-announcement__body', [
          h('h1', 'A New Version of GreenBelt'),
          h('p', [
            "We're excited to announce a brand-new version of GreenBelt with enhanced features and functionality.",
          ]),
          h('div.updates-list', [
          ...
          h('p', [
            'You can still use the current version of GreenBelt. The new version is still in beta, ' +
        ...
        h('section.new-ui-announcement__footer', [
          h('h1', 'Ready to try the new GreenBelt?'),
          h('button.positive', {
