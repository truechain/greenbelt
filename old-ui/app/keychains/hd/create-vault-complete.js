...
function mapStateToProps (state) {
  return {
    ...
    cachedSeed: state.greenbelt.seedWords,
  }
}
  ...
  return (
    ...
    h('.initialize-screen.flex-column.flex-center.flex-grow', [
      ...
      h('div', {
        ...
        h('span.error', 'These 12 words are the only way to restore your GreenBelt accounts.\nSave them somewhere safe and secret.'),
      ]),
      ...
      h('button.primary', {
        onClick: () => exportAsFile(`GreenBelt Seed Words`, seed),
        style: {
          margin: '10px',
          fontSize: '0.9em',
        },
