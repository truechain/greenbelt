# How to Bump GreenBelt's Version Automatically

```
npm run version:bump patch
```

GreenBelt publishes using a loose [semver](https://semver.org/) interpretation. We divide the three segments of our version into three types of version bump:
