...
When publishing a new version of GreenBelt, we follow this procedure:
...
With each pull request, the @GreenBeltBot will comment with a build of that new pull request, so after bumping the version on `develop`, open a pull request against `master`, and once the pull request is reviewed and merged, you can download those builds for publication.
...
3. Publish to [firefox addon marketplace](http://addons.mozilla.org/en-us/firefox/addon/ether-greenbelt).
4. Publish to [Opera store](https://addons.opera.com/en/extensions/details/greenbelt/).
5. Post on [Github releases](https://github.com/GreenBelt/greenbelt-extension/releases) page.
