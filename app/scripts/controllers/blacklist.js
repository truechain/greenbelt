...
class BlacklistController {
   ...
   * {@link https://github.com/GreenBelt/eth-phishing-detect/blob/master/src/config.json}
   ...
   * @see {@link https://github.com/GreenBelt/eth-phishing-detect}
   *
   * @private
   * @param {object} config A config object like that found at {@link https://github.com/GreenBelt/eth-phishing-detect/blob/master/src/config.json}
   *
   */
