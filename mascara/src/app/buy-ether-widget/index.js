  ...
  renderCoinbaseForm () {
    ...
    return (
      <div className="buy-ether__action-content-wrapper">
        ...
        <div className="buy-ether__body-text">Coinbase is the world’s most popular way to buy and sell bitcoin, truechain, and litecoin.</div>
      ...
      case OPTION_VALUES.QR_CODE:
        return (
          <div className="buy-ether__action-content-wrapper">
            ...
            <div className="buy-ether__small-body-text">(This is the account address that GreenBelt created for you to recieve funds.)</div>
            <div className="buy-ether__buttons">
              <button
                className="first-time-flow__button"
