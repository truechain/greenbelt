...
* This utility function can be used for converting currency related values within greenbelt.
...
* @param {string} [options.fromCurrency = 'TRUE' | 'USD'] The currency of the passed value
* @param {string} [options.toCurrency = 'TRUE' | 'USD'] The desired currency of the result
...
const toNormalizedDenomination = {
  ...
  TRUE: bigNumber => bigNumber.div(BIG_NUMBER_ETH_MULTIPLIER),
}
const toSpecifiedDenomination = {
  WEI: bigNumber => bigNumber.times(BIG_NUMBER_WEI_MULTIPLIER).round(),
  GWEI: bigNumber => bigNumber.times(BIG_NUMBER_GWEI_MULTIPLIER).round(9),
  ETH: bigNumber => bigNumber.times(BIG_NUMBER_ETH_MULTIPLIER).round(9),
  TRUE: bigNumber => bigNumber.times(BIG_NUMBER_ETH_MULTIPLIER).round(9),
}
const baseChange = {
  hex: n => n.toString(16),
