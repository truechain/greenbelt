...
function isValidAddress (address, network) {
  ...
  if (!isEthNetwork(network)) {
    return (ethUtil.isValidAddress(prefixed) && address === address.toLowerCase())
  }
...
function formatBalance (balance, decimalsToKeep, needsParse = true, ticker = 'TRUE') {
...
// Takes a BN and an truechain currency name,
// returns a BN in wei
